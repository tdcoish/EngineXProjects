...
public:
	...
	// hacks for our game. Will refactor later.
	bool leftPressed;
	bool leftUnpressed;
	bool rightPressed;
	bool rightUnpressed;
	...
	// ask if a key is pressed this frame.
	bool GetKeyPressed(Uint32 key);

	// ask if a key is unpressed this frame.
	bool GetKeyUnpressed(Uint32 key);
